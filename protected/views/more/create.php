...
<body>
	<form enctype="multipart/form-data" action="<?php echo $this->createUrl('more/doCreate')?>" method="post" onsubmit="return validate();">
		...
		<ul class="bd_list">
			...
			<li>
				<input type="file" class="input_file" name="w_pic" />
			</li>
			<li>
