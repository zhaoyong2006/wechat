...
<body>
	...
	<div class="friendsInfo">
		<div class="infoDiv">
			<span class="nickname"><?php echo $fansinfo['fans_neck'];?></span><?php if($fansinfo['fans_sex'] == '1'){ echo "♂";}elseif($fansinfo['fans_sex'] == '2'){ echo "♀";}else{ echo "保密";}?><span class="favorite"><?php echo $fansinfo['fans_platform'];?></span><button id="praiseBtn" class="cupid-blue" onclick="praise()">赞 +0</button>
		</div>
		<dl>
			<dd>
